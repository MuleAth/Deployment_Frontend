...
const HeroSection = () => {
  ...
  const [formData, setFormData] = useState({
    reason: "Feature Request", // Set default reason since category is disabled
    description: "",
  });
  ...
  const handleFeedbackSubmit = async (e) => {
    ...
    if (!formData.description.trim()) {
      setError("Please share your thoughts with us before submitting.");
      setIsSubmitting(false);
      return;
    }
    ...
    try {
      ...
      setFormData({ reason: "Feature Request", description: "" });
      setRating(0);
            ...
            <div className="w-full max-w-md bg-white rounded-xl shadow-2xl overflow-hidden animate-scale-up max-h-[80vh] overflow-y-auto">
              ...
              <div className="p-5">
                ...
                <form onSubmit={handleFeedbackSubmit} className="space-y-4">
                  ...
                  {/* Category with icons (pre-selected) - more compact */}
                  <div className="relative">
                    <label className="flex items-center text-gray-700 text-sm font-medium mb-1">
                      Category
                      <span className="ml-2 text-xs text-indigo-600 bg-indigo-100 px-2 py-0.5 rounded-full">Pre-selected</span>
                    </label>
                    <div className="relative">
                      <select
                        disabled
